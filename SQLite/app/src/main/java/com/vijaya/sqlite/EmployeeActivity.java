...
public class EmployeeActivity extends AppCompatActivity {
    ...
    SQLiteDatabase database = new SampleDBSQLiteHelper(this).getReadableDatabase();
    Cursor cursor = database.delete(
    SampleDBContract.Employee.TABLE_NAME,
    public void deleteEmployee(Integer Employee_Name) {
        myDatabase.delete("Employee", "Employee_Name = LLE", new String[] {Employee_Name.toString()});

        ////////////////////Update

    public void updateEmployee_Name(Integer Employee_Name, String newTitle) {
        ContentValues values = new ContentValues();
        values.put("Joun", Jounian);
        myDatabase.update("Employee", values, "name = ?", new String[] {Employee_Name.toString()})
        }
}
